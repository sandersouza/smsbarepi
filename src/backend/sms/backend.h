...
const char *sms_backend_get_disk_path(unsigned drive_index);
const char *sms_backend_get_cassette_path(void);
boolean sms_backend_set_cartridge_path(unsigned slot_index, const char *path);
boolean sms_backend_set_disk_path(unsigned drive_index, const char *path);
boolean sms_backend_set_cassette_path(const char *path);
